...
export default () => {
    ...
    const onRewardChanged = async (e) => {
        ...
        const isExceeded = value > availableBalance
                                    ...
                                    <div className="card px-0 py-0 mt-3 mb-3">
                                        ...
                                        <form id="msform">
                                            ...
                                            <div className="mt-4">
                                                ...
                                                <span className={`float-end${availableBalance < reward? " text-danger": " text-muted"}`}>{`Available Balance: +${availableBalance}`}</span>
                                                </div>
                                                <input type="number" step="0.1" min="0" max={availableBalance} value={reward} onChange={onRewardChanged} />
                                                <div className={`${approveAmount > 0 ? "": " d-none"}`}>
                                                ...
                                                <div style={{ padding: "16px" }}>
                                                    <input type="button" name="next" className="next action-button" value="Next" onClick={onNextStep} disabled={exceedBalance || approveAmount > 0} />
